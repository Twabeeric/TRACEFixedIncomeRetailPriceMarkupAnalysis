...
p15 = ggplot()+geom_point(aes(x = ddxnpp$trd_exctn_dt[which(ddxnpp$cusip_id=="369604BQ5")], y=ddxnpp$rptd_pr[which(ddxnpp$cusip_id=="369604BQ5")]), data=ddxnpp[which(ddxnpp$cusip_id=="369604BQ5"),], color='red', alpha=.5) + geom_point(aes(x = ddxnpp$trd_exctn_dt[which(ddxnpp$cusip_id=="369604BQ5")], y=ddxnpp$rptd_pr..10[which(ddxnpp$cusip_id=="369604BQ5")]), data=ddxnpp[which(ddxnpp$cusip_id=="369604BQ5"),], shape = 17,colour = 'grey', alpha=.7)+ylim(c(70, 100)) + labs(subtitle="Volume vs Prices", 
       y="Prices", 
       x="Volume", 
       title="Scatterplot")
plot(p15)
